    ...
    stage('Clean and Build') {
      steps {
        withSonarQubeEnv('sonarqube') {
          ...
          sh 'dotnet /opt/sonarscanner/SonarQubeScannerMSBuild/SonarScanner.MSBuild.dll end /d:sonar.login=7fcfcf6e197cb915aa463035592b2de52451bf9a'
        }
